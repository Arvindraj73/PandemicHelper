...
public class MaterialsFragment extends Fragment implements View.OnClickListener {
    ...
    private MaterialCardView mapSelect, details;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.mapSelect:
                openFragment(new ReliefCenterFragment());
                break;

            case R.id.details:
                openFragment(new MaterialDetailsFragment());
                break;
        }
    }
    ...
    private void openFragment(Fragment fragment) {
        ...
        transaction.replace(R.id.d2_container, fragment);
