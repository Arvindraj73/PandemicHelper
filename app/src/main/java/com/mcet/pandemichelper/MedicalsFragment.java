...
public class MedicalsFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mFusedLocationProviderClient = LocationServices.getFusedLocationProviderClient(MedicalsFragment.this.getContext());
        ...
        try {
            ...
            new Handler().postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    mMap.clear();
                    String url = getUrl(mLastKnownLocation.getLatitude(), mLastKnownLocation.getLongitude(), "pharmacy");
